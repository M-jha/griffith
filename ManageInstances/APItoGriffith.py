...
from chat_bot.chat_service import GPTFunctionExecutor
from Notifications import NotificatonV1
from datetime import datetime
from collections import defaultdict
from datetime import datetime, timedelta# Import defaultdict
...
def bot_interaction():
    ...
    try:
        ...
        # If we don't have previous function details and the user input is 'NO' or 'no' or 'No'
        if not previous_function_details and user_input.lower().strip() in ["NO", "no", "No"]:
